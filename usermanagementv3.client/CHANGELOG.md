...
- Create Angular project with ng: `ng new usermanagementv3.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`usermanagementv3.client.esproj`).
